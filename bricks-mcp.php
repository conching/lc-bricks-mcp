 ...
 * Description:       AI-powered assistant for Bricks Builder. Control your website with natural language through MCP-compatible AI tools like Claude. [SH local patch: theme_style styles->settings arg mapping + save_elements template meta key + global class settings key]
 * Version:           1.5.1.3
...
// Plugin version.
define( 'BRICKS_MCP_VERSION', '1.5.1.3' );
